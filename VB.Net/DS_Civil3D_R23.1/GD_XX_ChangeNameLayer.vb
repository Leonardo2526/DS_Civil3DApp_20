...
Public Class GD_XX_ChangeNameLayer
    <CommandMethod("GD_XX_ChangeNameLayer")>
    Public Sub GD_XX_ChangeNameLayer()
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Dim CurLayerName As String = "ЖД_"
        ...
        End Using
    End Sub
    <CommandMethod("XX_GD_ChangeNameLayer")>
    Public Sub XX_GD_ChangeNameLayer()
        ' '' Get the current document and database
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        Dim ed As Editor = acDoc.Editor
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Dim NewLayerName As String = "ЖД_"
            Dim n As Integer = 0
