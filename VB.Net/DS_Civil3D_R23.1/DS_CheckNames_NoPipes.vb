...
Public Class DS_CheckNames_NoPipes
    <CommandMethod("DS_CheckNames_NoPipes")>
    Public Sub DS_CheckNames()
        ...
        Using ts As Transaction = adoc.Database.TransactionManager.StartTransaction()
            ...
            Dim TypeList As New List(Of String) From
               {"AECC_TIN_SURFACE", "AECC_ALIGNMENT", "AECC_CORRIDOR", "AECC_PROFILE", "AECC_PROFILE_VIEW", "AECC_PARCEL", "AECC_ASSEMBLY", "AECC_SUBASSEMBLY", "AECC_NETWORK", "AECC_SECTION"}
