...
Public Class TS_XX_ChangeNameLayer
    <CommandMethod("TS_XX_ChangeNameLayer")>
    Public Sub TS_XX_ChangeNameLayer()
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Dim CurLayerName As String = "ТС_"
            ...
            Try
                ...
                For Each acObjId As ObjectId In acLyrTbl
                    ...
                    If acLyrTblRec.Name.StartsWith(CurLayerName, StringComparison.OrdinalIgnoreCase) = True Then
    ...
    <CommandMethod("XX_TS_ChangeNameLayer")>
    Public Sub XX_TS_ChangeNameLayer()
        ' '' Get the current document and database
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        Dim ed As Editor = acDoc.Editor
        ...
        Using acTrans As Transaction = acCurDb.TransactionManager.StartTransaction()
            ...
            Dim NewLayerName As String = "ТС_"
            Dim n As Integer = 0
