...
Public Class DS_CheckNames
    ...
    Public Sub ExcelExport(ByVal TypeList, ByVal ForbiddenObjTypeList, ByVal ForbiddenObjectNames, ByVal ed)
        ...
        oBook.SaveAs("C:\Отчёт по Civil 3D\Отчёт по проверке имён объектов модели Civil 3D.xls")
        oExcel.Quit
        Application.ShowAlertDialog("Отчёт сохранён:" & vbLf & "C:\Отчёт по Civil 3D\Отчёт по проверке имён объектов модели Civil 3D.xls")
    End Sub
End Class
